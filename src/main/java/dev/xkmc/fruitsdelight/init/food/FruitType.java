...
public enum FruitType {
	...
	HAWBERRY(4, 0xBF1D1D, FDTrees.HAWBERRY, List.of(new EffectFunc(FDEffects.APPETIZING::get, lv -> lv * 20))),
	...
	PEACH(2, 0xE78264, FDTrees.PEACH, List.of(new EffectFunc(FDEffects.HEAL_AURA::get, lv -> lv * 10))),
	PEAR(2, 0xBECB32, FDTrees.PEAR, List.of(new EffectFunc(FDEffects.LOZENGE::get, lv -> lv * 20))),
	PERSIMMON(2, 0xE15F1E, FDTrees.PERSIMMON, List.of(new EffectFunc(FDEffects.ASTRINGENT::get, lv -> lv * 80))),
	...
	CRANBERRY(4, 0xCF2626, FDBushes.CRANBERRY, List.of(new EffectFunc(FDEffects.SHRINKING::get, lv -> lv * 80))),
	MANGOSTEEN(2, 0xFBECD6, FDTrees.MANGOSTEEN, List.of(new EffectFunc(FDEffects.SLIDING::get, lv -> lv * 80))),
	...
	BAYBERRY(4, 0x541135, FDTrees.BAYBERRY, List.of(new EffectFunc(FDEffects.LEAF_PIERCING::get, lv -> lv * 20))),
	KIWI(2, 0x89D90D, FDTrees.KIWI, List.of(new EffectFunc(FDEffects.CYCLING::get, lv -> lv * 4))),
	FIG(2, 0xE08517, FDTrees.FIG, List.of(new EffectFunc(FDEffects.DIGESTING::get, lv -> lv * 80))),
