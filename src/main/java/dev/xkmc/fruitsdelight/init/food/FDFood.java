...
public enum FDFood implements IFDFood {
	...
	MANGOSTEEN_CAKE(FoodType.PLATE, FruitType.MANGOSTEEN, FDBlocks.MANGOSTEEN_CAKE::get, new EffectEntry(ModEffects.NOURISHMENT, 1200)),
	PEAR_WITH_ROCK_SUGAR(FruitType.PEAR, FoodType.BOWL, new EffectEntry(ModEffects.NOURISHMENT, 1200)),
	...
	BOWL_OF_PINEAPPLE_FRIED_RICE(FruitType.PINEAPPLE, FoodType.STAPLE, new EffectEntry(ModEffects.NOURISHMENT, 6000)),
